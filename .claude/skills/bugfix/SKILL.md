...
1. **Investigate**: Use @hestia-explorer (Task with subagent_type=hestia-explorer) to read all relevant source files and trace the bug
...
- Use `sanitize_for_log(e)` in any new error handling, never raw `{e}`
