...
2. Read `CLAUDE.md` — check the Context Continuity and Current Status sections
...
6. Run `source .venv/bin/activate && python -m pytest --tb=line -q 2>&1 | tail -10` to verify test baseline
