...
public struct Order: Identifiable, Codable, Equatable, Sendable {
    ...
    public var frequency: OrderFrequency
    public var resources: Set<MCPResource>
    public var orderStatus: OrderStatus
    public var lastExecution: OrderExecution?
    public let createdAt: Date
    public var updatedAt: Date

    public init(id: UUID, name: String, prompt: String, scheduledTime: Date, frequency: OrderFrequency, resources: Set<MCPResource>, orderStatus: OrderStatus, lastExecution: OrderExecution?, createdAt: Date, updatedAt: Date) {
        self.id = id
        self.name = name
        self.prompt = prompt
...
public enum OrderFrequency: Codable, Equatable, Sendable {
    case once
    case daily
    case weekly
    case monthly
    ...
    public static func from(type: String, customMinutes: Int) -> OrderFrequency {
        switch type {
        case "once": return .once
        case "daily": return .daily
        case "weekly": return .weekly
...
public struct OrderExecution: Identifiable, Codable, Equatable, Sendable {
    public let id: UUID
    ...
    public init(id: UUID, orderId: UUID, timestamp: Date, status: ExecutionStatus, hestiaRead: String?, fullResponse: String?) {
        self.id = id
...
public enum MCPResource: String, Codable, CaseIterable, Identifiable, Sendable {
...
extension Order {
    public static let mockOrders: [Order] = [
        Order(
            id: UUID(),
            name: "Morning Brief",
